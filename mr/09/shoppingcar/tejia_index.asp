...
sql="select * from tb_goods where sale=1 order by INTime desc"	'应用条件查询语句进行数据查询
...
<body>
<table width="800" height="524" border="0" align="center" cellpadding="0" cellspacing="0" background="images/new10.gif">
  <tr>
