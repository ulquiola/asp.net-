...
window.location.href="areaselect.asp?ProvinceID="+ProvinceID;}
}
</script>
<script language="javascript">
...
window.location.href="areaselect.asp?CityID="+CityID;}
else{
form1.town.value=0;}
}
</script>
...
function mycheck(){
  if(form1.town.value==0){
   ...
   window.close();
   window.open("add_ywyinfo.asp?qyNO="+qyNO,'','width=598,height=400');
}
</script>
  ...
  <tr>
    <td valign="top"><table width="400" height="271" cellpadding="-2" cellspacing="-2">
      ...
      <tr>
        ...
        <td valign="top">  
          <div align="center">
            <form name="form1" method="post" action="add_ywyinfo.asp">
