...
If (Request.QueryString("spnumber") <> "") Then 
  NO = Request.QueryString("spnumber")
End If
%>
<%
Set rs = Server.CreateObject("ADODB.Recordset")
sql = "SELECT * FROM DB_SPInfo WHERE spnumber = '" + Replace(NO, "'", "''") + "'"
            ...
            <table border="1" align="center" cellpadding="-2" cellspacing="-2" bordercolor="#669999" bordercolordark="#FFFFFF">
              <tr valign="baseline">
                ...
                <td width="102" valign="middle">
                  <div align="left">
                    &nbsp;<input name="spnumber" type="text" class="Sytle_text" value="<%=(rs.Fields.Item("spnumber").Value)%>" size="32" readonly="yes">
                  </div></td>
                <td width="88" bgcolor="#809EA4"><div align="center" class="style1">商品简称：</div></td>
                <td width="119" valign="middle"><div align="left">&nbsp;<input name="spsymbol" type="text" class="Sytle_auto" value="<%=(rs.Fields.Item("spsymbol").Value)%>" size="15">
                </div></td>
              </tr>
              <tr valign="baseline">
                ...
                <td colspan="3">
                  <div align="left">
                    &nbsp;<input name="spname" type="text" class="Style_upload" value="<%=(rs.Fields.Item("spname").Value)%>" size="32">
                  </div></td>
              </tr>
              <tr valign="baseline">
                ...
                <td valign="middle">
                  <div align="left">
                    &nbsp;<input name="pack" type="text" class="Sytle_text" value="<%=(rs.Fields.Item("pack").Value)%>" size="32">
                  </div></td>
                <td bgcolor="#809EA4"><div align="center" class="style1">类　　型：</div></td>
                <td valign="middle"><div align="left">&nbsp;<input name="type" type="text" class="Sytle_auto" value="<%=(rs.Fields.Item("type").Value)%>" size="15">
                </div></td>
              </tr>
              <tr valign="baseline">
              ...
              <tr valign="middle">
                <td height="38" colspan="4" align="right" nowrap>
                  <div align="center">                    <input name="Button" type="button" class="Style_button_del" value="关闭窗口" onClick="javascrip:opener.location.reload();window.close()">
                  </div></td>
                </tr>
            </table>
          </form>
