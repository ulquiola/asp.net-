...
If (Request.QueryString("ywynumber") <> "") Then 
  NO = Request.QueryString("ywynumber")
End If
Set rs = Server.CreateObject("ADODB.Recordset")
sql = "SELECT * FROM DB_WorkerInfo WHERE ywynumber = '" + Replace(NO, "'", "''") + "'"
            ...
            <table border="1" align="center" cellpadding="-2" cellspacing="-2" bordercolor="#669999" bordercolordark="#FFFFFF">
              ...
              <tr valign="middle">
                <td height="35" colspan="6" nowrap>                  <div align="center">
                    <input name="Submit2" type="button" class="Style_button_del" value="关闭窗口" onClick="JScript:window.close()">
                </div></td>
                </tr>
            </table>
