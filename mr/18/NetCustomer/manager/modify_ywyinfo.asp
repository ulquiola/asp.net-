...
<%'修改业务员信息
 if request.Form("name") <>"" then
  ...
  Up="update DB_WorkerInfo set sex='"&sex&"', folk='"&folk&"', birthday='"&birthday&_
  "', rcdate='"&rcdate&"', xl='"&xl&"', sfzNO='"&sfzNO&"', zy='"&zy&"', tel='"&tel&_
  "', workqy='"&workqy&"', address='"&address&"', email='"&email&"', memo='"&memo&_
  "'WHERE ywynumber = '"&session("NO")& "'"
  conn.execute(UP)%>
    ...
    <td valign="top"><table width="595" cellpadding="-2" cellspacing="-2">
      ...
      <tr>
        ...
        <td valign="top"><div align="center">
          <form ACTION="modify_ywyinfo.asp" METHOD="POST" name="form1">
            <table border="1" align="center" cellpadding="-2" cellspacing="-2" bordercolor="#669999" bordercolordark="#FFFFFF">
              <tr valign="middle">
                ...
                <td width="96"><div align="left">
                  <input name="name" type="text" class="Sytle_text" readonly="yes" value="<%=(rs.Fields.Item("name").Value)%>" size="32">
                </div></td>
              ...
              <tr valign="middle">
                ...
                <td><div align="left">
                  <input name="folk" type="text" class="Sytle_text" value="<%=(rs.Fields.Item("folk").Value)%>">
                </div></td>
              ...
              <tr valign="middle">
                ...
                <td colspan="5">                  <div align="left">
                    ...
                    <input name="workqy" type="hidden" id="workqy" value="<%=rs("workqy")%>">
                </div></td>
              </tr>
              <tr valign="middle">
              ...
              <tr valign="middle">
                <td height="35" colspan="6" nowrap><div align="center">
                    <input name="Button" type="button" class="Style_button_P" value="保存" onClick="mycheck()">                
                    <input name="Reset" type="reset" class="Style_button_P" value="重置">
                    <input name="modify" type="button" class="Style_button_P" value="修改密码" onClick="JScript:window.open('modifyPWD_ywy.asp','','width=400,height=271')">
                    <input name="Submit2" type="button" class="Style_button_P" value="关闭" onClick="JScript:window.close()">
                </div></td>
                </tr>
            </table>
          </form>
