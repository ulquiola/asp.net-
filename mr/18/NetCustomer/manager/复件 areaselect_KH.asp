            ...
            <table width="88%" height="142" border="1" cellpadding="-2" 
			 cellspacing="-2" bordercolor="#669999" bordercolordark="#FFFFFF">
              <tr>
				...
				<div align="center" class="style1">省级名称： </div></td>
                <td width="68%">
				<%
...
%>
  <option value="<%=rs_province("ID")%>" <%
   if rs_province("ID")=cint(session("SelectID_P")) then %>selected<% end if%>>
   <%=rs_province("Name")%></option>
  <%
