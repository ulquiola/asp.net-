...
sql="select * from Tab_person order by time1 desc"
...
<table width="814" height="505" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="488" valign="middle" background="../Images/main.gif"><table width="87%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="4%" valign="top"><div align="right"><img src="../Images/isexists.gif" width="16" height="16" /></div></td>
        <td width="80%" valign="bottom"><div align="left"><span class="STYLE2">&nbsp;</span><img src="../Images/per.gif" width="69" height="18" /></div></td>
        <td width="16%" valign="bottom" class="STYLE2">&nbsp;</td>
      </tr>
    </table>
      <br>
        <table width="90%" height="84%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="32"><table width="99%" height="32" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td background="../Images/waichubei.gif"><table width="97%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="4%" valign="bottom">&nbsp;</td>
                <td width="70%" valign="bottom">&nbsp;</td>
                <td width="10%" valign="bottom"><div align="right"><img src="../Images/add.gif" width="20" height="18" /></div></td>
                <td width="16%" valign="bottom" class="STYLE2">&nbsp;<a href="#" onclick="Javascript:window.open('person_add.asp','','width=560,height=360')">添加个人计划</a></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        <td valign="top">
		 <%
		If(rs.Eof)Then
			Response.Write("暂无个人计划信息!")
		Else
			
		%>
		<table width="728" height="55" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="23" valign="top"><div align="center" class="STYLE2">个人姓名</div></td>
          ...
          <tr>
			...
			<%if len(kk)>8 then%>
			<a href="#" onClick="Javascript:window.open('person_xianxi.asp?ID=<%=rs("ID")%>','','width=456,height=459')"><%=replace(left(kk,8)&"....",chr(13),"<br>")%></a>
			<%else%>
			<a href="#" onClick="Javascript:window.open('person_xianxi.asp?ID=<%=rs("ID")%>','','width=456,height=459')"><%=kk%></a>
			<%end if%>
		    &nbsp;
			</div></td>
            <td height="23" class="STYLE2"><div align="center">
            ...
            <td height="23"><div align="center"><a href="person_del.asp?id=<%=rs("id")%>" onclick="return confirm('是否确认删除?')"><img src="../Images/del.gif" width="16" height="16" border="0"></a></div></td>
          </tr>
		  <%
	  rs.movenext
