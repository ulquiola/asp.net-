...
<table width="557" height="401" border="0" cellpadding="-2" cellspacing="-2" background="../Images/detail0.gif">
  <tr>
    <td width="817" height="349" valign="top"><table width="100%" height="102"  border="0" cellpadding="-2" cellspacing="-2">
      <tr>
        <td height="44" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE5">员工信息修改成功</span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <form name="form1" method="post" action="">
        <table width="80%" height="169"  border="0" align="center" cellpadding="-2" cellspacing="-2">
          <tr>
            ...
            <div align="center"><span class="style3">员工信息修改成功！</span></div></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><div align="center">
                <input name="myclose" type="button" class="Style_button_del" id="myclose" value="关闭窗口" onClick="javascrip:opener.parent.location.reload();window.close()">
            </div></td>
          </tr>
        </table>
      </form></td>
