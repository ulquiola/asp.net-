...
{alert("请输入出差地区，再进行出差登记!!");form1.chuarea.focus();return;}
if(form1.time1.value=="")
{alert("请输入出差时间!!");form1.time1.focus();return;}
if(form1.time2.value=="")
{alert("请输入出差回归时间!!");form1.time2.focus();return;}
form1.submit();
}
</script>
<body>
...
<table width="627" height="436" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="bottom" background="../Images/qingjia_add.gif"><table width="617" height="433" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25" colspan="8">&nbsp;&nbsp;<span class="STYLE4">出差登记</span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="93" height="222"><span class="STYLE2">出差地区/原因</span></td>
        <td colspan="7"><label>
          <textarea name="chuarea" cols="70" rows="19" wrap="physical" id="chuarea"></textarea>
        </label></td>
      </tr>
      <tr>
        <td height="25" class="STYLE2"><div align="center">出差时间</div></td>
        ...
        <td width="17" height="25" class="STYLE2">至</td>
