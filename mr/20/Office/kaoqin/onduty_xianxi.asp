...
sql="select * from Tab_onduty where ID="&ID
...
<table width="458" height="459" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="../Images/waichudeng.gif"><table width="442" height="448" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="42" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE2">上下班登记详细信息</span></td>
      </tr>
      <tr>
        <td height="406"><table width="427" height="222" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <tr>
            ...
            <td height="38" valign="middle" class="STYLE3"><select name="enroltype" id="enroltype">
              <option value="上班登记"<%If (Not isNull((rs("enroltype")))) Then If ("上班登记" = CStr((rs("enroltype")))) Then Response.Write("SELECTED") : Response.Write("")%>>上班登记</option>
			   <option value="下班登记"<%If (Not isNull((rs("enroltype")))) Then If ("下班登记" = CStr((rs("enroltype")))) Then Response.Write("SELECTED") : Response.Write("")%>>下班登记</option>
			    <option value="加班登记"<%If (Not isNull((rs("enroltype")))) Then If ("加班登记" = CStr((rs("enroltype")))) Then Response.Write("SELECTED") : Response.Write("")%>>加班登记</option>
            </select>
</td>
          ...
          <tr>
            <td height="94" colspan="4" valign="top" class="STYLE3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;登记备注<strong>:</strong><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs("enrolremark")%></td>
          </tr>
        </table>
        <br>
