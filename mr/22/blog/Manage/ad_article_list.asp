...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top">
    <td height="5" background="images/mid_beijing.jpg"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="22"><img src="images/dian.gif" width="7" height="7"> 文章列表</td>
      </tr>
      <tr>
    ...
    <table width="550" border="0" align="center" cellpadding="0" cellspacing="2">
      ...
      <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr align="center">
          <td width="86">类别</td>
          <td width="77" height="22">作者</td>
          <td width="191" height="22">文章标题</td>
          <td width="146" height="22">操 作</td>
        </tr>
<%
...
If txt_class<>"" and txt_class<>"选择类别" Then sqlstr=sqlstr&" and Aclass="&txt_class&""
...
%>
	...
	%></td>
            ...
            <td height="22"><input name="id" type="hidden" id="id" value="<%=rs("id")%>">
                <a href="ad_article.asp?id=<%=rs("id")%>&action=view">修改</a> <a href="ad_article_commend.asp?id=<%=rs("id")%>&Atitle=<%=rs("Atitle")%>">评论</a>
