...
<form name="HtmlEditForm" action="news_save.asp" method=post>
  <table border="1" align="center" bordercolor="#CCCCCC" cellpadding="0" cellspacing="0" width="100%" height="400">
    <tr>
      <td colspan="2" align="center"><input type=hidden name=body id=Hidden1>
        ...
        <textarea name="oldContent" style="display:none"><%=(r.Fields.Item("news_main").Value)%></textarea>
        <script language="JavaScript">
<!--
    ...
    <tbody>
      <tr>
        <td colspan="2" height="60" align="center"><input type="hidden" name="userId" value="xingworld">
          ...
          &nbsp;&nbsp;
          <input type="button" name="submit2" style="background-color=buttonface" value="  取  消  " onClick="window.close();return false;">
        </td>
      </tr>
    </tbody>
  </table>
