...
<link 
href="../templet1/css/css.css" rel=stylesheet type="text/css">
<style type="text/css">
<!--
  ...
  <tr> 
    <td width="156" valign="top" height="356" bgcolor="#DFF0F7"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <% End If %>
        <% If (p1.Fields.Item("yin_4").Value) <> ("Y") Then 'script %>
        <tr> 
          <td height="25"> 
        ...
        <% End If %>
        <% If (p1.Fields.Item("yin_5").Value) <> ("Y") Then 'script %>
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
        ...
        <% End If %>
        <% If (p1.Fields.Item("yin_7").Value) <> ("Y") Then 'script %>
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
    ...
    <td width="615" valign="top" height="356" bgcolor="#FFFFFF">       <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr> 
          <td><img src="images/arrow.gif" width="13" height="13"> <%=(p1.Fields.Item("title3").Value)%></td>
        </tr>
        <tr> 
          <td height="6"></td>
        </tr>
        ...
        <tr> 
          <td> 
            <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td><%=(p1.Fields.Item("main3").Value)%></td>
              </tr>
            </table>
          </td>
        </tr>
