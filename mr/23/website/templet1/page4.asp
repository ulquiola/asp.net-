...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="379">
  <tr> 
    <td width="156" valign="top" height="356" bgcolor="#DFF0F7"> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DFF0F7">
        <tr> 
        ...
        <% End If %>
        <% If (p1.Fields.Item("yin_news").Value) <> ("Y") Then 'script %>
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
        ...
        <% End If %>
        <% If (p1.Fields.Item("yin_6").Value) <> ("Y") Then 'script %>
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
        ...
        <tr> 
          <td height="13"> 
            <div align="center"><font color="#000000">访问人次 <span class="pt9"><%=(p1.Fields.Item("hit").Value)%></span></font></div>
          </td>
        </tr>
      </table>
    </td>
    ...
    <td width="615" valign="top" height="356" bgcolor="#FFFFFF">
	      <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td><img src="images/arrow.gif" width="13" height="13"> <%=(p1.Fields.Item("title4").Value)%></td>
        </tr>
        <tr> 
          <td height="6"></td>
        </tr>
        ...
        <tr> 
          <td> 
            <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                <td><%=(p1.Fields.Item("main4").Value)%></td>
              </tr>
            </table>
          </td>
        </tr>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#999999">
  ...
  <tr> 
    <td> 
      <div align="center"> <font color="#FFFFFF">电话:<%=(p1.Fields.Item("phone").Value)%> 
        ...
        <% End If %>
        &nbsp;E-mail:<%=(p1.Fields.Item("email").Value)%> &nbsp;&copy;&nbsp;<%=(p1.Fields.Item("title").Value)%> &nbsp;版权所有</font></div>
    </td>
  </tr>
  <tr> 
    <td height="8"> 
