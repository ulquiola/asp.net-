...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="29">
  ...
  <tr>
    <td height="27" bgcolor="#DFF0F7"><table width="85%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="379">
  <tr>
    <td width="156" valign="top" height="356" bgcolor="#DFF0F7"><table width="97%" border="0" cellspacing="0" cellpadding="0">
        <tr>
    ...
    <td width="615" valign="top" height="356" bgcolor="#FFFFFF"><table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          <td><img src="images/arrow.gif" width="13" height="13"> <%=(p1.Fields.Item("title6").Value)%></td>
        </tr>
        <tr>
          <td height="6"></td>
        </tr>
        ...
        <tr>
          <td><table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td><%=(p1.Fields.Item("main6").Value)%></td>
              </tr>
            </table></td>
        </tr>
        <tr>
