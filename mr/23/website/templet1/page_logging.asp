...
If MR_valUsername <> "" Then
  ...
  MR_redirectLoginSuccess="../weblogo.asp"
...
<table width="778" border="0" cellspacing="0" cellpadding="0" height="79" align="center" background="images/1-1.gif">
  <tr> 
    <td height="61"> 
      <% If (p1.Fields.Item("logo").Value) <> ("0.bmp") Then %>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="29">
  <tr> 
    <td height="22" bgcolor="#FFFFFF"> 
      <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="pt9">
        <tr> 
          <td height="22" bgcolor="#FFFFFF"><marquee> <font color="#000000">
            <% If (p1.Fields.Item("yin_zimu").Value) <> ("Y") Then %>
            <%=(p1.Fields.Item("zimu").Value)%></font> <font color="#000000">
            <% End If %>
            </font> </marquee></td>
        </tr>
      </table>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" align="center" height="379">
  <tr> 
    <td width="156" valign="top" height="356" bgcolor="#DFF0F7"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25" bgcolor="#FFFFFF"> 
            <div align="center"><img src="images/5-4.gif" width="79" height="19"></div>
          </td>
        </tr>
        ...
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page1.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title1").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page_news.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title_news").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page3.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title3").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="25"> 
            <table width="99%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page4.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title4").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page5.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title5").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="25"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="25">
              <tr> 
                <td width="22%">&nbsp;</td>
                <td><a href="page6.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>" class="<%=(p1.Fields.Item("font1").Value)%>"><%=(p1.Fields.Item("title6").Value)%></a> 
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr> 
          <td height="13"> 
            <div align="center" class="pt9"><font color="#000000">访问人次 <%=(p1.Fields.Item("hit").Value)%></font></div>
          </td>
        </tr>
      </table>
    </td>
    <td width="10" valign="top" height="356" bgcolor="#FFFFFF"> 
      <div align="center"><img src="images/2-2.gif" width="1" height="450"></div>
    </td>
    <td width="615" valign="top" height="356" bgcolor="#FFFFFF"> <!-- #BeginEditable "main" --> 
      <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td><img src="images/arrow.gif" width="13" height="13"> <%=(p1.Fields.Item("title7").Value)%></td>
        </tr>
        <tr> 
          <td height="6"></td>
        </tr>
                ...
                <tr> 
                  <td valign="top" bgcolor="#EFEFEF"> 
                    <table width="297" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td height="60" bgcolor="#EFEFEF">&nbsp;</td>
                      </tr>
                      <tr> 
                        <td bgcolor="#EFEFEF"> 
                          <table width="94%" border="0" cellspacing="0" cellpadding="6" align="center" bgcolor="#EFEFEF">
                            <tr> 
                              <td width="30%"> 
                                <div align="right">用户：</div>
                              </td>
                              <td> 
                                <input type="text" name="username" style="BORDER-RIGHT: rgb(0,0,0) 1px solid; BORDER-TOP: rgb(0,0,0) 1px solid; BORDER-LEFT: rgb(0,0,0) 1px solid; BORDER-BOTTOM: rgb(0,0,0) 1px solid; HEIGHT: 20px" size="17" maxlength="20" value="<%=(p1.Fields.Item("id").Value)%>">
                              </td>
                            </tr>
                            <tr> 
                              <td width="30%"> 
                              ...
                              <td> 
                                <input type="password" name="password" style="BORDER-RIGHT: rgb(0,0,0) 1px solid; BORDER-TOP: rgb(0,0,0) 1px solid; BORDER-LEFT: rgb(0,0,0) 1px solid; BORDER-BOTTOM: rgb(0,0,0) 1px solid; HEIGHT: 20px" size="17" maxlength="20">
                              </td>
                            </tr>
                            <tr> 
                              <td width="30%"> 
                              ...
                              <td> 
                                <input style="BORDER-RIGHT: #EFEFEF 1px solid; BORDER-TOP: #EFEFEF 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #EFEFEF 1px solid; BORDER-BOTTOM: #EFEFEF 1px solid; HEIGHT: 22px; background-color: #EFEFEF; cursor:hand" type="submit" value=" 登 录 " name="Submit">
                                <input style="BORDER-RIGHT: #EFEFEF 1px solid; BORDER-TOP: #EFEFEF 1px solid; FONT-SIZE: 9pt; BORDER-LEFT: #EFEFEF 1px solid; BORDER-BOTTOM: #EFEFEF 1px solid; HEIGHT: 22px; background-color: #EFEFEF; cursor:hand" type="reset" value=" 重 置 " name="Reset">
                              </td>
                            </tr>
                          </table>
                        </td>
...
<table width="776" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="22" background="../templet1/images/line1.gif" bgcolor="#A6B0DD"><table width="776" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <tr>
    <td height="4" bgcolor="#FFFFFF" background="../website/templet1/images/line1_1.gif"></td>
  </tr>
</table>
