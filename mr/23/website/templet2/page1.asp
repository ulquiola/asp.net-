...
<table width="776" border="0" cellspacing="0" cellpadding="0" height="60" align="center" background="images/back.gif">
  <tr>
    <td><% If (p1.Fields.Item("logo").Value) <> ("0.bmp") Then %>
...
<table width="776" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr valign="top">
    <td width="128" bgcolor="#e6e6e6" background="../website/templet2/images/cpjs.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page1.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title1").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page_news.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title_news").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page3.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title3").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page4.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title4").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page5.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title5").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page6.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title6").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        ...
        <tr>
          <td width="128" height="36" background="images/a.gif"><table width="128" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="20">&nbsp;</td>
                <td><div align="center" class="<%=(p1.Fields.Item("font1").Value)%>"><A HREF="page_logging.asp?<%= MR_keepNone & MR_joinChar(MR_keepNone) & "id=" & p1.Fields.Item("id").Value %>"><%=(p1.Fields.Item("title7").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <% End If %>
        <tr>
          <td width="128" height="36"><table border="0" cellspacing="0" cellpadding="2" align="center" width="100%">
              ...
              <tr>
                <td><div align="center" class="pt9">访问人次 <font color="#FF0000"><%=(p1.Fields.Item("hit").Value)%></font></div></td>
              </tr>
            </table></td>
        </tr>
        <tr>
    ...
    <td width="648" bgcolor="#FFFFFF"><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
          ...
          <td height="42"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="42">
              <tr>
                ...
                <td><table width="254" border="0" cellspacing="0" cellpadding="0" height="42">
                    <tr>
                      <td background="images/jj.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="42">
                          <tr>
                            <td width="36%"></td>
                            <td valign="bottom"><div align="left"><b class="pt105"><font color="#3366FF"><%=(p1.Fields.Item("title1").Value)%></font></b></div></td>
                          </tr>
                          <tr>
        ...
        <tr>
          <td><%=(p1.Fields.Item("main1").Value)%></td>
        </tr>
        <tr>
          <td height="40">&nbsp;</td>
        </tr>
    ...
    <td height="22" background="../website/templet2/images/line1.gif" bgcolor="#A6B0DD"><table width="776" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td bgcolor="#CCCCCC" height="17"><div align="right">电话:<%=(p1.Fields.Item("phone").Value)%>
              ...
              <% End If %>
              &nbsp;E-mail:<%=(p1.Fields.Item("email").Value)%> &nbsp;&copy;&nbsp;<%=(p1.Fields.Item("title").Value)%> &nbsp;版权所有</div></td>
