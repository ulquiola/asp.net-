...
if request("action")="add" then
	...
	rs.close
	set rs=nothing
	response.Write("<script>alert('留言发布成功！');window.location.href='index.asp';</script>")
end if
%>
<table width="792" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="590" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="590">
      <tr>
        <td colspan="3"><img name="index_7_r1_c1" src="images/yhly.jpg" width="590" height="49" border="0" alt=""></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="564" valign="top">
          ...
          <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
            <form name="myform" action="liuyan.asp" method="post" onSubmit="return addbook();">
              ...
              <tr height="20" bgcolor="#FFFFFF" align="center">
                <td>内&nbsp;&nbsp;容：</td>
                <td><div align="left">
                    <textarea name="neirong" cols="60" rows="16"></textarea>
                </div></td>
              </tr>
              <tr height="20" bgcolor="#FFFFFF" align="center">
                <td colspan="2">
